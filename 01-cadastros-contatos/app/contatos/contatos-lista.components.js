...
var ContatosListaComponent = (function () {
    function ContatosListaComponent(contatoService, dialigService) {
        this.contatoService = contatoService;
        this.dialigService = dialigService;
        this.contatos = [];
    }
    ...
    ContatosListaComponent.prototype.onDelete = function (contato) {
        var _this = this;
        this.dialigService.confirm('Deseja deletar o contato ' + contato.nome + '?')
...
ContatosListaComponent = __decorate([
    core_1.Component({
        ...
        templateUrl: 'contato-lista.components.html'
    }),
    __metadata("design:paramtypes", [contato_service_1.ContatoService,
        dialog_service_1.DialogService])
], ContatosListaComponent);
exports.ContatosListaComponent = ContatosListaComponent;
//# sourceMappingURL=contatos-lista.components.js.map